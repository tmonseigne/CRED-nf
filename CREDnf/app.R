...
sumResponseIDs <- paste0("sumR", checkIDs)	# 
sumTickIDs <- paste0("sumT", checkIDs)			# 


# Lisdt of possible choice in formular
ticklist <- c(
	"Avoiding EEG artefacts",
...
ui <- fluidPage(
	...
	navlistPanel("Domains",
		...
		# Checklist Tab
		tabPanel("Checklist summary", tags$span(style = "color:red", strong(em( textOutput("warningtext")))),
