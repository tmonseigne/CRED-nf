...
- \fancyfoot[C]{\itshape{This report has been generated using the CRED-nf online checklist Beta version, adapted from the CRED-nf manuscript which is freely available here [hyperlink to published version to come].}}
- \fancyhead[R]{\thepage}
- \pagestyle{fancy}
